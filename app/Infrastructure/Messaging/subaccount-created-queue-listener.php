...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['SERVICES_ACCESS_SUBACCOUNT_CREATED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    echo " [*] Waiting for subaccount to be created  to exit press CTRL+C\n";
